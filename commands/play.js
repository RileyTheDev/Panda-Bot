    ...
    async execute(message, args, cmd, client, Discord){
        ...
        if (cmd === 'play'){
            ...
            if (ytdl.validateURL(args[0])) {
              ...
              //Continuing off of what CodeLyon made in the Advanced Music Bot tutorial, link: https://www.youtube.com/watch?v=riyHsgI2IDs
            //Put this in the same format that you made the skip/stop command in the Advanced Music Bot tutorial.
            //Instead of using "cmd" I just used args[0], you can change it to the way you'd like.
